    ...
    <div className="w-full">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-travel-muted">
          Active reservations across the platform
        </p>
      </div>
      ...
      {!loading && !error && currentBookings && currentBookings.length === 0 && (
        <div className="text-center py-20">
          ...
          <p className="text-gray-600">There are no active bookings at the moment</p>
        </div>
      )}
      ...
      {!loading && !error && currentBookings && currentBookings.length > 0 && (
        <div className="space-y-4">
          {currentBookings.map((booking, i) => (
            <div
              key={i}
              className="rounded-2xl border border-slate-200/80 bg-white/95 p-6 shadow-sm transition hover:border-travel-primary/20 hover:shadow-card"
            >
